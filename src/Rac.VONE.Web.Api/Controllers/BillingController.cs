...
namespace Rac.VOne.Web.Api.Controllers
{
    ...
    public class BillingController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<Billing>>> Save(IEnumerable<Billing> billings, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<int>> SaveDiscount(BillingDiscount discount, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<int>> SaveMemo(BillingMemo memo, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<Billing>>> Get([FromBody] long[] ids, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<BillingDiscount>>> GetDiscount([FromBody] long billingId, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<string>> GetMemo([FromBody] long id, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<bool>> ExistCollectCategory([FromBody] int categoryId, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<bool>> ExistBillingCategory([FromBody] int categoryId, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<bool>> ExistStaff([FromBody] int staffId, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<Billing>>> InputScheduledPayment(IEnumerable<Billing> billings, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<int>> Delete(BillingDeleteSource source, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<int>> DeleteDiscount([FromBody] long billingId, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<int>> DeleteMemo([FromBody] long Id, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<BillingDueAtModify>>> GetDueAtModifyItems(BillingSearch option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<Billing>>> UpdateDueAt(IEnumerable<BillingDueAtModify> billings, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<Customer>>> GetImportNewCustomer(TransactionImportSource source, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<ImportDataResult>> ImportPaymentSchedule(TransactionImportSource source, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<JournalizingSummary>>> GetBillingJournalizingSummary(BillingJournalizingOption option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<BillingJournalizing>>> ExtractBillingJournalizing(BillingJournalizingOption option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<Billing>>> UpdateOutputAt(BillingJournalizingOption option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<Billing>>> CancelBillingJournalizing(BillingJournalizingOption option, CancellationToken token)
