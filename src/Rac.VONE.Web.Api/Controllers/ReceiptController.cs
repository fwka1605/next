...
namespace Rac.VOne.Web.Api.Controllers
{
    ...
    public class ReceiptController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<ReceiptInputsResult>> Save(ReceiptSaveItem items, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<int>> Delete([FromBody] long id, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<Receipt>>> Get([FromBody] long[] ids, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<Receipt>>> GetItems(ReceiptSearch option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<AdvanceReceiptsResult>> GetAdvanceReceipts([FromBody] long originalReceiptId, CancellationToken token)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult< ReceiptExcludeResult >> SaveExcludeAmount(IEnumerable<ReceiptExclude> excludes, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<ReceiptMemo>> SaveMemo(ReceiptMemo memo)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<bool>> DeleteMemo(long receiptId)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<string>> GetMemo([FromBody] long receiptId, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<AdvanceReceivedResult>> SaveAdvanceReceived(IEnumerable<AdvanceReceived> receiveds, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<AdvanceReceivedResult>> CancelAdvanceReceived(IEnumerable<AdvanceReceived> receiveds, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<ReceiptHeader>>> GetHeaderItems([FromBody] int companyId, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<ReceiptApportion>>> GetApportionItems([FromBody] IEnumerable<long> headerIds, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<ReceiptApportionsResult>> Apportion(IEnumerable<ReceiptApportion> apportions, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<bool>> ExistCompany([FromBody] int CompanyId, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<bool>> ExistExcludeCategory([FromBody] int CategoryId, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<bool>> ExistOriginalReceipt([FromBody] long ReceiptId, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<bool>> ExistNonApportionedReceipt(ClosingSearch option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<bool>> ExistNonOutputedReceipt(ClosingSearch option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<bool>> ExistNonAssignmentReceipt(ClosingSearch option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<ReceiptSectionTransfersResult>> SaveReceiptSectionTransfer(IEnumerable<ReceiptSectionTransfer> transfers, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<ReceiptSectionTransfer>>> GetReceiptSectionTransferForPrint([FromBody] int companyId)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<ReceiptSectionTransfer>>> UpdateReceiptSectionTransferPrintFlag([FromBody] int companyId)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<int>>> ReceiptImportDuplicationCheck(ReceiptImportDuplicationSearch option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<int>> AdvanceReceivedDataSplit(AdvanceReceivedSplitSource source, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<int>> CancelAdvanceReceivedDataSplit(AdvanceReceivedSplitSource source, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable< JournalizingSummary >>> GetReceiptJournalizingSummaryAsync(JournalizingOption option)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable< ReceiptJournalizing >>> ExtractReceiptJournalizingAsync(JournalizingOption option)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable< GeneralJournalizing >>> ExtractReceiptGeneralJournalizingAsync(JournalizingOption option)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<int>> UpdateOutputAtAsync(JournalizingOption option)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<int>> CancelReceiptJournalizingAsync(JournalizingOption option)
