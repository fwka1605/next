...
namespace Rac.VOne.Web.Api.Controllers
{
    ...
    [ApiController]
    public class CollationSettingController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<CollationSetting>> Get(CollationSetting setting, CancellationToken token)
        ...
        /// <param name="token">自動バインド</param>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<MatchingOrder>>> GetMatchingBillingOrder(CollationSetting setting, CancellationToken token)
        ...
        /// <param name="token">自動バインド</param>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<CollationOrder>>> GetCollationOrder(CollationSetting setting, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<CollationSetting>> Save(CollationSetting setting, CancellationToken token)
