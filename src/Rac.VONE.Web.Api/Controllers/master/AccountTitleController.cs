...
namespace Rac.VOne.Web.Api.Controllers
{
    ...
    public class AccountTitleController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<MasterData>>> GetImportItemsForCategory(MasterSearchOption option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<MasterData>>> GetImportItemsForCustomerDiscount(MasterSearchOption option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<MasterData>>> GetImportItemsForDebitBilling(MasterSearchOption option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<MasterData>>> GetImportItemsForCreditBilling(MasterSearchOption option, CancellationToken token)
