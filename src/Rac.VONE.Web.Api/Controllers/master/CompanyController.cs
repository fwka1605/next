...
namespace Rac.VOne.Web.Api.Controllers
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        /// <param name="token">自動バインド</param>
        [HttpPost]
        public async Task<ActionResult<int>> DeleteLogos(IEnumerable<CompanyLogo> logos, CancellationToken token)
        ...
        /// <param name="token">自動バインド</param>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<CompanyLogo>>> GetLogos([FromBody] int companyId, CancellationToken token)
        ...
        /// <param name="token">自動バインド</param>
        [HttpPost]
        public async Task<ActionResult<Company>> Save(Company company, CancellationToken token)
        ...
        /// <param name="token">自動バインド</param>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<CompanyLogo>>> SaveLogos(IEnumerable<CompanyLogo> logos, CancellationToken token)
