...
namespace Rac.VOne.Web.Api.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult<IEnumerable<Customer>>> GetItems(CustomerSearch option, CancellationToken token)
        ...
        /// <param name="token">自動バインド</param>
        [HttpPost]
        public async Task<ActionResult<Customer>> Save(Customer customer, CancellationToken token)
        ...
        [HttpPost]
        public async Task<ActionResult<IEnumerable<Customer>>> SaveItems(IEnumerable<Customer> customers, CancellationToken token)
        ...
        [HttpPost]
        public async Task<ActionResult<IEnumerable<CustomerMin>>> GetMinItems([FromBody] int companyId, CancellationToken token)
