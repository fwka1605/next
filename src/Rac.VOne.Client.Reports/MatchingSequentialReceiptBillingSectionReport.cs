...
namespace Rac.VOne.Client.Reports
{
    ...
    /// </summary>
    public partial class MatchingSequentialReceiptBillingSectionReport : GrapeCity.ActiveReports.SectionReport
    {
        private int useForeignCurrency = 0;
        private string displayFieldString = "#,###,###,###,##0";

        public MatchingSequentialReceiptBillingSectionReport()
        {
            //
        ...
        private void AllMatchingSectionReport_ReportStart(object sender, EventArgs e)
        {
            if (useForeignCurrency == 0)
            {
                ...
                lblPayerName.Location = new System.Drawing.PointF(lblPayerName.Location.X - lblCurrency.Width, lblPayerName.Location.Y);
                ...
                txtPayerName.Location = new System.Drawing.PointF(txtPayerName.Location.X - txtCurrency.Width, txtPayerName.Location.Y);
                ...
                lblPayerName.Width += lblCurrency.Width;
                txtPayerName.Width += txtCurrency.Width;
