...
{
    [DataContract]
    public class ReceiptJournalizing
    {
    ...
    [DataContract]
    public class ReceiptJournalizingsResult : IProcessResult
    {
        [DataMember] public ProcessResult ProcessResult { get; set; }
        [DataMember] public List<ReceiptJournalizing> ReceiptJournalizings { get; set; }
    }
