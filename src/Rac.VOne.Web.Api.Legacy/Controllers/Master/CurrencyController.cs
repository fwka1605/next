...
namespace Rac.VOne.Web.Api.Legacy.Controllers
{
    ...
    ///  
    /// </summary>
    public class CurrencyController : ApiControllerAuthorized
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<Currency>> GetItems(CurrencySearch option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<Currency> Save(Currency currency, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<MasterData>> GetImportItemsReceipt(MasterSearchOption option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<MasterData>> GetImportItemsNetting(MasterSearchOption option, CancellationToken token)
