...
namespace Rac.VOne.Web.Api.Legacy.Controllers
{
    ...
    /// </summary>
    public class SectionController : ApiControllerAuthorized
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task< Section > Save(Section section, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<int> Delete(Section section, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<Section>> GetItems(SectionSearch option, CancellationToken token)
