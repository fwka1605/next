...
namespace Rac.VOne.Web.Api.Legacy.Controllers
{
    ...
    ///  銀行口座マスター
    /// </summary>
    public class BankAccountController : ApiControllerAuthorized
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<BankAccount>> GetItems(BankAccountSearch option, CancellationToken token)
        ...
        /// <param name="token">自動バインド</param>
        [HttpPost]
        public async Task<BankAccount> Save(BankAccount account, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<int> Delete(BankAccount account, CancellationToken token)
