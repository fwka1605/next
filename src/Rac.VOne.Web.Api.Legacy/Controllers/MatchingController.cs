...
namespace Rac.VOne.Web.Api.Legacy.Controllers
{
    ...
    /// 消込関連
    /// </summary>
    public class MatchingController : ApiControllerAuthorized
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable< Collation >> CollateR(CollationSearch option)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<Collation>> Collate(CollationSearch option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task< MatchingResult > SequentialMatchingR(MatchingSequentialSource source)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<MatchingResult> SequentialMatching(MatchingSequentialSource source, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<int>> SimulateR(MatchingSimulationSource source)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<int>> Simulate(MatchingSimulationSource source)
        {
            await Task.Delay(TimeSpan.FromMilliseconds(0));
            return matchingCombinationSolveProcessor.Solve(source.Billings, source.TargetAmount);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<MatchingSource> SolveR(MatchingSource source)
            => await hubContext.DoAsync(async token
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<MatchingSource> Solve(MatchingSource source, CancellationToken token)
            => await matchingSolveProcessor.SolveAsync(source, source.Option, token: token);
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task< MatchingResult > MatchingIndividuallyR(MatchingSource source)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<MatchingResult> MatchingIndividually(MatchingSource source, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<MatchingHeader>> SearchMatchedData(CollationSearch option, CancellationToken token)
        {
            var result = (await matchingProcessor.SearchMatchedDataAsync(option, token)).ToArray();
            return result;
        }
        ...
        /// </remarks>
        [HttpPost]
        public async Task< MatchingResult > CancelMatchingR(MatchingCancelSource source)
        ...
        /// </remarks>
        [HttpPost]
        public async Task<MatchingResult> CancelMatching(MatchingCancelSource source, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<Billing>> SearchBillingData(MatchingBillingSearch option, CancellationToken token)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<Receipt>> SearchReceiptData(MatchingReceiptSearch option, CancellationToken token)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<MatchingHeadersResult> Approve(IEnumerable<MatchingHeader> headers, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<MatchingHeadersResult> CancelApproval(IEnumerable<MatchingHeader> headers, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable< Receipt >> SearchReceiptById(long[] ids, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<int> SaveWorkDepartmentTargetR(WorkDepartmentTargetSource source)
            => await hubContext.DoAsync(async token =>
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<int> SaveWorkDepartmentTarget(WorkDepartmentTargetSource source, CancellationToken token)
        {
            return await matchingProcessor.SaveWorkDepartmentTargetAsync(source.ClientKey, source.CompanyId, source.DepartmentIds, token);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<int> SaveWorkSectionTargetR(WorkSectionTargetSource source)
            => await hubContext.DoAsync(async token =>
            {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<int> SaveWorkSectionTarget(WorkSectionTargetSource source, CancellationToken token)
        {
            return await matchingProcessor.SaveWorkSectionTargetAsync(source.ClientKey, source.CompanyId, source.SectionIds, token);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<Matching>> Get([FromBody] long[] ids, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable< MatchingHeader >> GetHeaderItems([FromBody] long[] ids, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable< MatchingJournalizingDetail >> GetMatchingJournalizingDetailR(JournalizingOption option)
            => await hubContext.DoAsync(async token
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<MatchingJournalizingDetail>> GetMatchingJournalizingDetail(JournalizingOption option, CancellationToken token)
            => (await matchingJournalizingProcessor.GetDetailsAsync(option, token)).ToArray();
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task< MatchingJournalizingProcessResult > CancelMatchingJournalizingDetailR(
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<MatchingJournalizingProcessResult> CancelMatchingJournalizingDetail(
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable< JournalizingSummary >> GetMatchingJournalizingSummaryR(JournalizingOption option)
            => await hubContext.DoAsync(async token
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<JournalizingSummary>> GetMatchingJournalizingSummary(JournalizingOption option, CancellationToken token)
            => (await matchingJournalizingProcessor.GetSummaryAsync(option, token)).ToArray();
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable< MatchingJournalizing >> ExtractMatchingJournalizingR(JournalizingOption option)
            => await hubContext.DoAsync(async token
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<MatchingJournalizing>> ExtractMatchingJournalizing(JournalizingOption option, CancellationToken token)
            => (await matchingJournalizingProcessor.ExtractAsync(option, token)).ToArray();
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable< GeneralJournalizing >> ExtractGeneralJournalizingR(JournalizingOption option)
            => await hubContext.DoAsync(async token
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<GeneralJournalizing>> ExtractGeneralJournalizing(JournalizingOption option, CancellationToken token)
            => (await matchingJournalizingProcessor.ExtractGeneralJournalizingAsync(option, token)).ToArray();
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable< MatchedReceipt >> GetMatchedReceiptR(JournalizingOption option)
            => await hubContext.DoAsync(async token
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<MatchedReceipt>> GetMatchedReceipt(JournalizingOption option, CancellationToken token)
            => (await matchingJournalizingProcessor.GetMatchedReceiptAsync(option, token)).ToArray();
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<int> UpdateOutputAtR(JournalizingOption option)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<int> UpdateOutputAt(JournalizingOption option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<int> CancelMatchingJournalizingR(JournalizingOption option)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<int> CancelMatchingJournalizing(JournalizingOption option, CancellationToken token)
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable< MatchingJournalizing >> MFExtractMatchingJournalizingR(JournalizingOption option)
            => await hubContext.DoAsync(async token
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IEnumerable<MatchingJournalizing>> MFExtractMatchingJournalizing(JournalizingOption option, CancellationToken token)
            => (await matchingJournalizingProcessor.MFExtractAsync(option, token)).ToArray();
