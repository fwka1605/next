...
namespace Rac.VOne.Web.Api.Legacy
{
    ...
    public class SimpleInjectorQueryProcessorConfigurator
    {
        ...
        private void ConfigureTransactionsQueryProcessors()
        {
            ...
            container.Register<IAddImportDataQueryProcessor, ImportDataQueryProcessor>();
            container.Register<IAddImportDataDetailQueryProcessor, ImportDataDetailQueryProcessor>();
            container.Register<IImportDataDetailQueryProcessor, ImportDataDetailQueryProcessor>();
        }
