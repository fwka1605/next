...
{
    public class ZenginFixed1Header : FixedLengthRecord
    {
        public override IEnumerable<int> FieldLengthList { get; } = new[] { 1, 2, 1, 10, 40, 4, 4, 15, 3, 15, 1, 7, 17 };
        ...
        public ZenginFixed1Header(int lineNumber, string line)
