...
{
    public class MitsubishiUfjFactorDsv2Data : DsvRecord, IAccountTransferInformation
    {
        ...
        public MitsubishiUfjFactorDsv2Data(string[] fields, int lineNumber)
