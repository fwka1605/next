...
{
    public class SmbcFixed2Data : FixedLengthRecord, IAccountTransferInformation
    {
        public override IEnumerable<int> FieldLengthList { get; } = new[] { 1, 4, 15, 3, 15, 4, 1, 7, 30, 10, 1, 8, 12, 1, 8};
        ...
        public SmbcFixed2Data(int lineNumber, string line)
