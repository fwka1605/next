...
{
    using Bundle = ReadResultBundle<RisonaNetDsv1Header, RisonaNetDsv2Data, RisonaNetDsv8Trailer, DummyRecord>;
    public class RisonaNetDsvFileReader : IReader, IBundle<RisonaNetDsv1Header, RisonaNetDsv2Data, RisonaNetDsv8Trailer, DummyRecord>
    {
        ...
        private Record CreateRecord(string[] fields, int lineNumber)
        {
            ...
            switch (dataKubun)
            {
                case "1": return new RisonaNetDsv1Header    (fields, lineNumber);
                case "2": return new RisonaNetDsv2Data      (fields, lineNumber);
                case "8": return new RisonaNetDsv8Trailer   (fields, lineNumber);
        ...
        private List<Bundle> Read(string file)
        {
            ...
            return this.CreateBundles(records, RecordSetType.HDT, isMultiHeader: true);
        }
        /// <summary>
